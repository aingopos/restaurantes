...
public class InsumoJpaController implements Serializable {
    ...
    public InsumoJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Insumo insumo) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (findInsumo(insumo.getIdInsumo()) != null) {
    ...
    public void edit(Insumo insumo) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
